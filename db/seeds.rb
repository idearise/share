...
# validates_uniqueness_of error, but the validation still fails on apps 2 to 4!
app1 = App.find_or_initialize_by_name("example.com")
app1.website = "http://www.example.com"
...
app2.website = "http://www.android.com"
app2.about = "Android example app"
...
app3.website = "http://www.apple.com"
app3.about = "iOS example app"
...
app4.website = "http://www.microsoft.com"
app4.about = "Windows Phone app example"
