...
opts[:domain] = '.inthisapp.com' if not Rails.env.development?        # you can share between subdomains here: '.inthisapp.com'
Share::Application.config.session_store :active_record_store, opts